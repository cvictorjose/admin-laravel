...
@section('header')
    <h1>
        Promocode + Tracking List
        <small>Safe-bag Admin</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="/"><i class="fa fa-files-o"></i> Home</a></li>
        <li class="active">Promocode + Tracking </li>
        <li class="active">Promocode + Tracking List</li>
    </ol>
@endsection
@section('content')
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Promocode + Tracking</h3>
                    <a href="{{ URL::to('admin/download_code_registration_track') }}" class="btn btn-app" style="float: right;">
                        <i class="fa fa-download"></i> Promocode registered + tracking List
                    </a>
                </div><!-- /.box-header -->
